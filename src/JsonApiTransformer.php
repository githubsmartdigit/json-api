 ...
 */
namespace Xooxx\JsonApi;

use Xooxx\JsonApi\Helpers\DataAttributesHelper;
use Xooxx\JsonApi\Helpers\DataIncludedHelper;
use Xooxx\JsonApi\Helpers\DataLinksHelper;
use Xooxx\JsonApi\Helpers\PropertyHelper;
use Xooxx\Api\Transformer\Helpers\RecursiveDeleteHelper;
use Xooxx\Api\Transformer\Helpers\RecursiveFilterHelper;
use Xooxx\Api\Transformer\Helpers\RecursiveFormatterHelper;
use Xooxx\Api\Transformer\Helpers\RecursiveRenamerHelper;
use Xooxx\Api\Transformer\Transformer;
...
class JsonApiTransformer extends Transformer
{
     ...
     * @param array $value
     *
     * @throws \Xooxx\Api\Transformer\TransformerException
     *
     * @return string
     */
    ...
    {
        /** @var \Xooxx\Api\Mapping\Mapping $mapping */
    ...
    /**
     * @param \Xooxx\Api\Mapping\Mapping $mapping
     *
