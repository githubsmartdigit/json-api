 ...
 */
namespace Xooxx\JsonApi\Http\Request;
...
class Request extends \Zend\Diactoros\Request
{
    ...
    /**
     * @return \Xooxx\JsonApi\Http\Request\Parameters\Sorting
     */
    ...
    /**
     * @return \Xooxx\JsonApi\Http\Request\Parameters\Page
     */
    public function getPage()
    {
        $queryParam = $this->getQueryParam('page');
        $page = new Page(!empty($queryParam['number']) ? $queryParam['number'] : 1, !empty($queryParam['cursor']) ? $queryParam['cursor'] : null, !empty($queryParam['limit']) ? $queryParam['limit'] : null, !empty($queryParam['offset']) ? $queryParam['offset'] : null, !empty($queryParam['size']) ? $queryParam['size'] : null);
        return $page;
    }
    /**
     * @return array
    ...
    /**
     * @return \Xooxx\JsonApi\Http\Request\Parameters\Fields
     */
