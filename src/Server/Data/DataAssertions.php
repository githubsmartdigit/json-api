...
use Xooxx\JsonApi\Server\Errors\MissingAttributesError;
...
class DataAssertions
{
     ...
     * @throws \ReflectionException
     */
    protected static function assertItTypeMemberIsExpectedValue(array $data, JsonApiSerializer $serializer, $className, ErrorBag $errorBag)
    {
